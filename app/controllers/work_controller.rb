class WorkController < ApplicationController
  ...
  def index
    ...
    @selected_theme = t('work.index.default_select_theme')
    @selected_image_name = 'Механика вдохновения'
    @values_qty = Value.all.count
    @current_locale = I18n.locale
    @themes = Theme.all.pluck(:name)
    @default_image_name = 'Drowing.jpg'
  ...
  def display_theme
    ...
    if params[:theme] == "-----" #.blank?
      ...
      data = { index: 0, name: 'Механика вдохновения', values_qty: values_qty,
               file: 'Drowing.jpg', image_id: 9,
